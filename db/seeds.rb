...
users = [
  {username: "hurdy", password_digest: "gravlax", location: "NYC", avatar_img_url: "/img/swedish_chef.jpg"},
  {username: "ironchef", password_digest: "sushi", location: "Japan", avatar_img_url: "/img/iron_chef.jpg"},
]
